...
// Post a user role
ipcMain.on('postUserRole', (event, userId, role) => {
	if( role === 'teacher')
		requestWin.webContents.send('postUserRoleTeacher', userId);
	else if ( role === 'consultant')
		requestWin.webContents.send('postUserRoleConsultant', userId);
});

// Delete a user role
ipcMain.on('deleteUserRole', (event, userId, role) => {
	if( role === 'teacher')
		requestWin.webContents.send('deleteUserRoleTeacher', userId);
	else if ( role === 'consultant')
		requestWin.webContents.send('deleteUserRoleConsultant', userId);
});
